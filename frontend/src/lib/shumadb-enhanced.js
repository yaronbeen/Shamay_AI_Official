...
class ShumaDBEnhanced {
  ...
  static async _saveExtractedData(client, shumaId, sessionId, extractedData) {
    ...
    if (extractedData.buildingPermitNumber || extractedData.buildingPermitDate) {
      ...
      `, [
        ...
        extractedData.buildingPermitNumberConfidence || 0.95,
        formatDateForDB(extractedData.buildingPermitDate) || null,
        extractedData.buildingPermitDateConfidence || 0.95,
        extractedData.permittedUse || null,
        extractedData.permittedUseConfidence || 0.95,
        extractedData.overallConfidence || 0.90
      ])
    }
    ...
    if (extractedData.buildingDescription || extractedData.buildingFloors) {
      ...
      `, [
        ...
        extractedData.buildingDescriptionConfidence || 0.95,
        extractedData.buildingFloors || null,
        extractedData.buildingFloorsConfidence || 0.95,
        extractedData.buildingAddress || null,
        extractedData.buildingAddressConfidence || 0.95,
        extractedData.totalSubPlots || null,
        extractedData.totalSubPlotsConfidence || 0.95,
        extractedData.overallConfidence || 0.90
      ])
    }
  }
  ...
  static async saveGISData(sessionId, gisData) {
    ...
    try {
      ...
      await this._saveGISScreenshots(client, shumaId, sessionId, gisData)
  ...
  static async savePermitExtraction(sessionId, permitData, documentFilename) {
    ...
    try {
      ...
      `, [
        documentFilename,
        permitData.permitNumber, permitData.permitNumberConfidence || 0.95, permitData.permitNumberContext || '',
        formatDateForDB(permitData.permitDate), permitData.permitDateConfidence || 0.95, permitData.permitDateContext || '',
        permitData.permittedUsage, permitData.permittedUsageConfidence || 0.95, permitData.permittedUsageContext || '',
        permitData.localCommitteeName, permitData.localCommitteeNameConfidence || 0.95, permitData.localCommitteeNameContext || '',
        permitData.overallConfidence || 0.90,
  ...
  static async saveLandRegistryExtraction(sessionId, landRegistryData, documentFilename) {
    ...
    try {
      ...
      `, [
        documentFilename,
        landRegistryData.gush ? parseInt(landRegistryData.gush) : null, landRegistryData.gushConfidence || 0.95, landRegistryData.gushContext || '',
        landRegistryData.parcel ? parseInt(landRegistryData.parcel) : null, landRegistryData.parcelConfidence || 0.95, landRegistryData.parcelContext || '',
        landRegistryData.subParcel ? parseInt(landRegistryData.subParcel) : null, landRegistryData.subParcelConfidence || 0.95, landRegistryData.subParcelContext || '',
        landRegistryData.registeredArea, landRegistryData.registeredAreaConfidence || 0.95, landRegistryData.registeredAreaContext || '',
        JSON.stringify(landRegistryData.attachments || []), landRegistryData.attachmentsConfidence || 0.95,
        JSON.stringify(landRegistryData.owners || []), landRegistryData.ownersConfidence || 0.95, landRegistryData.owners ? landRegistryData.owners.length : 0,
        landRegistryData.overallConfidence || 0.90
      ])
  ...
  static async saveSharedBuildingExtraction(sessionId, sharedBuildingData, documentFilename) {
    ...
    try {
      ...
      `, [
        documentFilename,
        formatDateForDB(sharedBuildingData.orderIssueDate), sharedBuildingData.orderIssueDateConfidence || 0.95,
        sharedBuildingData.buildingDescription, sharedBuildingData.buildingDescriptionConfidence || 0.95, sharedBuildingData.buildingDescriptionContext || '',
        sharedBuildingData.buildingFloors, sharedBuildingData.buildingFloorsConfidence || 0.95, sharedBuildingData.buildingFloorsContext || '',
        sharedBuildingData.buildingSubPlotsCount, sharedBuildingData.buildingSubPlotsCountConfidence || 0.95, sharedBuildingData.buildingSubPlotsCountContext || '',
        sharedBuildingData.buildingAddress, sharedBuildingData.buildingAddressConfidence || 0.95, sharedBuildingData.buildingAddressContext || '',
        sharedBuildingData.totalSubPlots, sharedBuildingData.totalSubPlotsConfidence || 0.95, sharedBuildingData.totalSubPlotsContext || '',
        JSON.stringify(sharedBuildingData.subPlots || []),
        JSON.stringify(sharedBuildingData.buildingsInfo || []),
        sharedBuildingData.overallConfidence || 0.90
      ])
