...
export const LOCKED_HEBREW_TEXT: LockedHebrewText = {
  ...
  // Chapter 6
  finalValuationTemplate: 'בשים לב למיקומו של הנכס, לשטחו, ולכל שאר הנתונים כאמור וכמפורט לעיל, בהביאי בחשבון שווים של נכסים דומים רלוונטיים, סביר לאמוד את שווי הנכס בגבולות, ‎{{asset_value_num}}‎ (‎{{asset_value_txt}}‎).',
  
  currentStateText: 'הכול במצבו הנוכחי, כריק, פנוי וחופשי מכל מחזיק, חוב ושיעבוד, נכון לתאריך חוות-דעת זו.',
  
  declarationText: 'הנני מצהיר, כי אין לי כל עניין אישי בנכס נשוא השומה, בבעלי הזכויות בו במזמין השומה.\n\nהדו"ח הוכן על פי תקנות שמאי המקרקעין (אתיקה מקצועית), התשכ"ו – 1966 ועל פי התקנים המקצועיים של הועדה לתקינה שמאית.',
