...
export function Step5ValuationPanel({ data, updateData, sessionId }: Step5ValuationPanelProps) {
  ...
  useEffect(() => {
    const loadSessionData = async () => {
      ...
      try {
        ...
        console.error('❌ Step5ValuationPanel: Failed to load session data', error)
      }
    }
