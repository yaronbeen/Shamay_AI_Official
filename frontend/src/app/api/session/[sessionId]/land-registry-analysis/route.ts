...
export async function POST(
  ...
  try {
    ...
    const mappedData = {
      ...
      construction_year: extractedData.constructionYear,
      property_condition: extractedData.propertyCondition,
      finish_standard: extractedData.finishStandard,
      unit_description: extractedData.unitDescription,
      floor: extractedData.floor,
      building_number: extractedData.buildingNumber,
      shared_areas: extractedData.sharedAreas,
